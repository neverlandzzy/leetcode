...
public class Solution {
    ...
    public static void main(String[] args) {
		String test1 = "XXYX";
		List<String> list1 = new ArrayList<>(Arrays.asList("XXX", "XXY", "XYX", "XYY", "YXZ"));
		
		String test2 = "XYZ";
		List<String> list2 = new ArrayList<>(Arrays.asList("XYD", "YZE", "DEA", "FFF"));
		
		System.out.println(pyramidTransition(test1, list1));
		System.out.println(pyramidTransition(test2, list2));
	}
}
