...
public class Solution {
    /**
     * Given a directed acyclic graph, with n vertices numbered from 0 to n-1, and an array edges where edges[i] = [fromi, toi] represents a
    ...
    public static void main(String[] args) {
        ...
        test1.add(Arrays.asList(0, 2));
        test1.add(Arrays.asList(2, 5));
        test1.add(Arrays.asList(3, 4));
        test1.add(Arrays.asList(4, 2));
        System.out.println(findSmallestSetOfVertices(6, test1));

        List<List<Integer>> test2 = new ArrayList<>();
        test2.add(Arrays.asList(0, 1));
        test2.add(Arrays.asList(2, 1));
        test2.add(Arrays.asList(3, 1));
        test2.add(Arrays.asList(1, 4));
        test2.add(Arrays.asList(2, 4));
        System.out.println(findSmallestSetOfVertices(5, test2));
    }
}
