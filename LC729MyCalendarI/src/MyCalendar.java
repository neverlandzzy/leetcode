...
public class MyCalendar {
	...
	// Solution 1: Brute-force O(N^2) N:the number of calls
	/*
	List<int[]> calendar;
    ...
    */
    ...
    // Solution 2: TreeMap O(N*logN) N:the number of calls
    ...
    public boolean book(int start, int end) {
        ...
        Integer largerKey = map.ceilingKey(start);
        
        if ((smallerKey != null && start < map.get(smallerKey))) {
        	return false;
        }
        
        if ((largerKey != null && end > largerKey)) {
        	return false;
        }
