...
public class Solution {
    ...
    public static void main(String[] args) {
        int[][] test1 = {{20190101,0,1},{20190104,3,4},{20190107,2,3},{20190211,1,5},{20190224,2,4},{20190301,0,3},{20190312,1,2},{20190322,4,5}};
        int[][] test2 = {{0,2,0}, {1,0,1}, {3,0,3}, {4,1,2}, {7,3,1}};

        System.out.println(earliestAcq(test1, 6));
        System.out.println(earliestAcq(test2, 4));
    }
}
