...
public class Solution {
    ...
    public static void main(String[] args) {
		...
		int[] test2 = {5, 5, 10};
		int[] test3 = {10, 10};
		int[] test4 = {5,5,10,10,20};
		
		System.out.println(lemonadeChange(test1));
		System.out.println(lemonadeChange(test2));
		System.out.println(lemonadeChange(test3));
		System.out.println(lemonadeChange(test4));
	}
}
