...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        test1.add(Collections.singletonList(1));
        test1.add(Collections.singletonList(2));
        test1.add(Collections.singletonList(3));
        test1.add(Collections.emptyList());

        System.out.println(canVisitAllRooms(test1));

        List<List<Integer>> test2 = new ArrayList<>();
        test2.add(Arrays.asList(1, 3));
        test2.add(Arrays.asList(3, 0, 1));
        test2.add(Arrays.asList(2));
        test2.add(Arrays.asList(0));

        System.out.println(canVisitAllRooms(test2));
    }
}
