public class Solution {
    ...
    private static boolean valid(int[] weights, int days, long sum) {
        int counter = 1;
        long total = 0;
    ...
    public static void main(String[] args) {
        ...
        int[] test2 = {3,2,2,4,1,4};
        int[] test3 = {1,2,3,1,1};

        System.out.println(shipWithinDays(test1, 5));
        System.out.println(shipWithinDays(test2, 3));
